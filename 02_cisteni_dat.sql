...
update t_import set stredisko=N'CC' where (misto=N'Žilina' or misto=N'Lugoj' and Mandant=N'MAND30')
update t_import	set stredisko=N'HR' where (misto=N'Bukureš Sklad' and Mandant=N'MAND30')
update t_import	set stredisko=N'DP' where (misto!=N'Žilina' and misto!=N'Bukureš Sklad' and misto!=N'Lugoj' and Mandant=N'MAND30')

--doplneni statu v zahranici dle vyplatniho mista
update t_import set stat=N'DE' where (stat is null and misto=N'Nìmecko')
update t_import	set stat=N'SK' where (stat is null and misto=N'Žilina')	
...
update t_import	set stat=N'PL' where (stat is null and (misto=N'Varšava Arkadia' or misto=N'Varšava - Prosta' or misto=N'Varšava Blue city' or misto=N'Gdaòsk' or misto=N'Katowice' or misto=N'Poznañ' or misto=N'Kraków Bonarka' or misto=N'Wroclaw' or misto=N'Krakow Kamienna' or misto=N'Lodž'))	
